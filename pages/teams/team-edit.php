					...
					<form method="post" action="/submit-edit-team/<?php echo encryptID($id) ?>">
						<div class="card">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
										...
										<div class="form-group">
											...
											<input type="text" minlength="4" class="form-control required<?php if($err) { echo ' is-invalid'; } ?>" id="team_name" name="team_name" placeholder="<?php echo renderLang($team_name_placeholder); ?>" value="<?php echo $team_name; ?>" required>
							...
							<div class="card-footer text-right">
								<a href="/teams" class="btn btn-secondary mr-1"><i class="fa fa-arrow-left mr-2"></i><?php echo renderLang($btn_back); ?></a>
