					...
					<form action="/submit-add-document" method="post" id="add_form">
						<div class="modal-body">
							...
							<div class="form-group w-100 m-0">
								...
								<input type="text" minlength="4" maxlength="20" class="form-control required<?php if($err) { echo ' is-invalid'; } ?>" id="name" name="name" placeholder="<?php echo renderLang($document_name_placeholder); ?>" required>
