...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2022 at 09:12 AM
...
(1, 'superadmin', '$2y$10$V20FOs0HNEu/ggAzHF9dquhjf/472JyT6u4ioMl2LtQJeqH/TRHNK', 'Julcess', 'Mercado', 0, 20, 1662704797, 2, NULL, 0, 0),
(37, 'adminrye', '$2y$10$GHrT/jMl9hfd/dbof9kOvOaX1.zI1M4PlHkuhujorqmNX6Bs5.aIO', 'Ryan', 'Verba', 0, 20, 1662705161, 0, NULL, 0, 0);
...
(1, 'Ambassador', 'test,test-add,test-edit,test-delete', 0, 0),
(2, 'Admin', 'all', 0, 0),
(3, 'Test Role', 'test,test-add,test-edit,test-delete', 0, 0),
(4, 'Test test role', 'users', 0, 0);
...
INSERT INTO `users` (`user_id`, `user_employee_id`, `user_email`, `user_password`, `user_firstname`, `user_middlename`, `user_lastname`, `user_nickname`, `user_photo`, `role_ids`, `permissions`, `user_position`, `user_level`, `user_gender`, `user_mobile`, `team_id`, `user_hiredate`, `user_enddate`, `starting_date`, `data_per_page`, `user_last_login`, `user_log_attempts`, `lockout_timestamp`, `user_status`, `temp_del`) VALUES
(1, '2200057', 'julcess-marie.m1@trans-cosmos.co.jp', '$2y$10$V20FOs0HNEu/ggAzHF9dquhjf/472JyT6u4ioMl2LtQJeqH/TRHNK', 'Julcess', 'Papica', 'Mercado', 'cess', 'julcessmercado.jpg', ',3,', ',', 1, 1, '0', '09754310357', 1, 0, 0, 0, 20, 1662705085, NULL, NULL, 0, 0);
...
--
ALTER TABLE `admins`
  MODIFY `admin_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
