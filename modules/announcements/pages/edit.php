					...
					<form method="post" action="/submit-<?php echo $process.'-'.$prefix; ?>" enctype="multipart/form-data">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="row text-left">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-12">
                                            <label class="mr-1">Last Date Edited</label> 
							...
							<div class="card-footer text-right">
								...
								<a href="/announcements" class="btn btn-default"><i class="fa fa-arrow-left mr-2"></i><?php echo renderLang($btn_back); ?></a>
