...
<head>
	...
	<title>DX info Hub <?php echo renderLang($admins_edit_admin); ?> </title>
					...
					<form method="post" action="/submit-edit-admin">
						...
						<div class="card">
							...
							<div class="card-footer text-right">
								<a href="/admins" class="btn btn-default mr-1"><i class="fa fa-arrow-left mr-2"></i><?php echo renderLang($btn_back); ?></a>
