							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
                                        ...
                                        <input type="text" name="uname" class="form-control required" id="uname" placeholder="User Name" required="">
									</div>

									<!-- EMPLOYEE ID -->
									<div class="col-lg-3 col-md-4 col-sm-2">
										<label class="mr-1">Employee ID</label> 
                                        <input type="text" name="employeeid" class="form-control required" id="uname" placeholder="First Name" required="">
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
                                        ...
                                        <input type="text" name="team" class="form-control required" id="team" placeholder="Team" required="">
									</div>

									<!-- Position -->
									<div class="col-lg-3 col-md-4 col-sm-2">
										<label class="mr-1">Position</label> 
                                        <input type="text" name="position" class="form-control required" id="position" placeholder="Position" required="">
									</div>
								</div>
								<br>
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
                                        ...
                                        <input type="password" name="upass" class="form-control required" id="upass" placeholder="Enter Password" required="">
									</div>

									<!-- PASSWORD -->
									<div class="col-lg-3 col-md-4 col-sm-2">
										<label class="mr-1">Confirm Password</label> 
                                        <input type="password" name="cpass" class="form-control required" id="upass" placeholder="Confirm Password" required="">
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
										...
										<input type="text" name="firstname" class="form-control required" id="firstname" placeholder="First Name" required="">
									</div>

									<!-- MIDDLENAME -->
									<div class="col-lg-3 col-md-4 col-sm-2">
										<label class="mr-1">Middle name</label> 
                                        <input type="text" name="middlename" class="form-control required" id="midlename" placeholder="Middle Name" required="">
									</div>

									<!-- LASTNAME -->
									<div class="col-lg-3 col-md-4 col-sm-2">
										<label class="mr-1">Last Name</label> 
                                        <input type="text" name="lastname" class="form-control required" id="lastname" placeholder="Last Name" required="">
									</div>
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
                                        ...
                                        <div class="field">
                                            <span>
                                                <input type="file" id="files" name="filename" required>
                                            </span>
                                        </div>
                                    </div>
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
                                        ...
                                        <input type="text" name="mobile" class="form-control required" id="mobile" placeholder="Mobile" required="">
									</div>
