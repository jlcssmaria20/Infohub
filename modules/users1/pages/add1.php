							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
                                        ...
                                        <input type="text" name="employeeid" class="form-control required" id="uname" placeholder="Emloyee ID" required="">
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
                                        ...
                                        <input type="text" name="middlename" class="form-control " id="midlename" placeholder="Middle Name" >
									</div>
