...
<head>
	...
	<title><?php echo renderLang($test_edit); ?> &middot; <?php echo $sitenamee; ?></title>
					...
					<form method="post" action="/submit-edit-test/<?php echo encryptID($id) ?>">
						<div class="card">
							...
							<div class="card-footer text-right">
								<a href="/test" class="btn btn-secondary mr-1"><i class="fa fa-arrow-left mr-2"></i><?php echo renderLang($btn_back); ?></a>
