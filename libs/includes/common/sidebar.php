		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				...
				if($_SESSION['sys_data']['photo'] == '') {
					...
					echo '<img src="'.$_SESSION['sys_data']['photo'].'" class="img-circle elevation-2" alt="User Image">';
				}
				?>
			</div>
			<div class="info">
				<a href="/profile/<?php echo encryptID($_SESSION['sys_data']['id'],'users'); ?>" class="d-block"><?php echo $_SESSION['sys_fullname']; ?></a>
			</div>
		</div>
