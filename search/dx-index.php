	...
	<div class="login-box">
		...
		<div class="card">
			...
			<div class="card-body login-card-body">
				...
				<p class="login-box-msg"><?php echo	 decryptStr("1/bw+u6mBa1RuTUoA0R5ThydkiEJKuSokCi6ObXkxwn5p4gBFpOoktJrULGO5ct18xVde5s6IQJXphOJBCKIFQ=="); ?></p>	
				<form action="/dx-login" method="post">
