...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2022 at 01:29 AM
...
(1, 'superadmin', '$2y$10$V20FOs0HNEu/ggAzHF9dquhjf/472JyT6u4ioMl2LtQJeqH/TRHNK', 'Julcess', 'Mercado', 0, 20, 1663034628, 2, NULL, 0, 0),
(37, 'adminrye', '$2y$10$GHrT/jMl9hfd/dbof9kOvOaX1.zI1M4PlHkuhujorqmNX6Bs5.aIO', 'Ryan', 'Verba', 0, 20, 1663111669, 0, NULL, 0, 0);
...
(2, 'Admin', 'all', 0, 0),
(3, 'Test Role', 'test,test-add,test-edit,test-delete', 2, 1663034352),
(4, 'Test test role', 'users', 2, 1663034147);
...
(11, 'test', 2, 1663032275, '2022-09-13 01:24:35');
...
(1, '2200057', 'julcess-marie.m1@trans-cosmos.co.jp', '$2y$10$V20FOs0HNEu/ggAzHF9dquhjf/472JyT6u4ioMl2LtQJeqH/TRHNK', 'Julcess', 'Papica', 'Mercado', 'Cess', 'julcessmercado.jpg', ',3,', ',', 1, 1, '0', '09754310357', 1, 20220914, 20270914, 'Time is Gold', 'php, js', 0, 20, 1662945130, NULL, NULL, 0, 0);
...
--
ALTER TABLE `files`
  MODIFY `id` int(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
