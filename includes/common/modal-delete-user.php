		...
		<div class="modal-content">
			...
			<form method="post"  action="/delete-<?php echo $prefix; ?>" >
				...
				<div class="modal-body">
					<h2>Are you sure you want to Deactivate <?php echo $delete; ?>?</h2>
					<br>
					<button type="submit" class="btn btn-danger btn-delete"><i class="fa fa-check mr-2"></i><?php echo 'Confirm Deactivate'?></button>
				</div>
