						...
						<div class="card">
                            <div class="card-header">
							    ...
							    <div class="card-tools">
									...
									<button type="submit" name="submit_file" class="btn btn-danger btn-md">
													...
													<?php 
														...
														while($data = $sql->fetch(PDO::FETCH_ASSOC)) {
															...
															echo '<label class="mr-1">File Name</label>';
																echo '<input type="text" name="docu_dl" value="'.$data['docu_dl'].'" class="form-control required"  placeholder="Download Name">';
															echo '</div>';
															echo '<div class="col-lg-5">';
															echo '<label class="mr-1">Download File</label>';
