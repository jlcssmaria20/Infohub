		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					...
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1><i class="far fa-user mr-3"></i><?php echo renderLang($users_add_user); ?></h1>
						</div>
					</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control required<?php if($mantra_in_life_err) { echo ' is-invalid'; } ?>" maxlength="200" id="mantra_in_life" name="mantra_in_life" placeholder="<?php echo renderLang($users_mantra_in_life_placeholder); ?>"<?php if(isset($_SESSION['sys_users_add_mantra_in_life_val'])) { echo ' value="'.$_SESSION['sys_users_add_mantra_in_life_val'].'"'; } ?> >
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control required<?php if($skills_err) { echo ' is-invalid'; } ?>" maxlength="200" id="skills" name="skills" placeholder="<?php echo renderLang($users_skills_placeholder); ?>"<?php if(isset($_SESSION['sys_users_add_skills_val'])) { echo ' value="'.$_SESSION['sys_users_add_skills_val'].'"'; } ?> >
