			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="card-header">
							<h3 class="card-title">Add Webinar and Event</h3>
							<div class="card-tools">
								<a href="add-webinar-and-events" class="btn btn-primary btn-md">
							...
							<div class="table-responsive">
								<table class="table table-data table-bordered table-striped table-hover">
									...
									<tbody>
										<?php
										$data_count = 0;
										$sql = $pdo->prepare("SELECT * FROM ".str_replace('-','_',$module).$where." ORDER BY date_set DESC LIMIT ".$sql_start.",".$numrows);
										$sql->execute();
										if($sql->rowCount() == 0) {
											...
											while($data = $sql->fetch(PDO::FETCH_ASSOC)) {
												...
												echo '>';
													...
													// Image
													echo '<td>
													<img src="/assets/uploadimages/'.$data['images'].'" style="width:200px;height:200px;" alt="'.$data['images'].'">
													</td>';
