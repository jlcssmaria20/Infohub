								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-2">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control required<?php if($nickname_err) { echo ' is-invalid'; } ?>" minlength="4" maxlength="50"  id="nickname" name="nickname" placeholder="<?php echo renderLang($users_nickname_placeholder); ?>" value="<?php echo $user_nickname; ?>" required>
