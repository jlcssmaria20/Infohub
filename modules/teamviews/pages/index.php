										...
										if($sql->rowCount() == 0) {
											...
											while($data = $sql->fetch(PDO::FETCH_ASSOC)) {
												...
												echo '>';
													...
													// Image
													echo '<td>
													<img src="/assets/uploadimages/'.$data['announcment_img'].'" style="width:200px;height:200px;" alt="'.$data['announcment_img'].'">
													</td>';
													...
													echo '<td> <a href="#">';?>
													<?php
														echo $data['date_edit'] != 0 ? date('F j, Y',strtotime($data['date_edit'])) : 'ー';
