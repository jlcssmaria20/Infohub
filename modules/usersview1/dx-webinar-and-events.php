            ...
            <div class="announcement mb-4">
                ...
                <div class="announcement-row">
                    <ul class="list-inline mb-4">
                        <?php
                            $x = array();
                            $sql = $pdo->prepare("SELECT * FROM webinarandevents ORDER BY date_set ASC");
                            $sql->execute();
                            ...
                            foreach($row as $key => $data) {
                                ...
                                if($data['status'] != 1) {
                                    ...
                                    elseif(substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー', 0, 5) == 'March') {
                                        echo '<h3 class="webinarandevent'.$data['img_count'].'  mb-2" id="subheading'.$key.'"> For ' .substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])): 'ー', 0, 5).'</h3>';  
                                        echo '<li class="list-inline-item">';
                                            echo '<span class="center mt-2" >';
                                                echo $data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー';
                                            echo '</span>';  
                                    ...
                                    elseif(substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー', 0, 3) == 'May') {
                                        echo '<h3 class="webinarandevent'.$data['img_count'].'  mb-2" id="subheading'.$key.'"> For ' .substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])): 'ー', 0, 3).'</h3>'; 
                                        echo '<li class="list-inline-item">';
                                            echo '<span class="center mt-2" >';
                                                echo $data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー';
                                            echo '</span>';  
                                    ...
                                    elseif(substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー', 0, 4) == 'June') {
                                        echo '<h3 class="webinarandevent'.$data['img_count'].'  mb-2" id="subheading'.$key.'"> For ' .substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])): 'ー', 0, 4).'</h3>'; 
                                        echo '<li class="list-inline-item">';
                                            echo '<span class="center mt-2" >';
                                                echo $data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー';
                                            echo '</span>';  
                                    ...
                                    elseif(substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー', 0, 6) == 'August') {
                                        echo '<h3 class="webinarandevent'.$data['img_count'].'  mb-2" id="subheading'.$key.'"> For ' .substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])): 'ー', 0, 6).'</h3>';
                                        echo '<li class="list-inline-item">';
                                            echo '<span class="center mt-2" >';
                                                echo $data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー';
                                            echo '</span>';  
                                    ...
                                    elseif(substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー', 0, 9) == 'September') {
                                        echo '<h3 class="webinarandevent'.$data['img_count'].'  mb-2" id="subheading'.$key.'"> For ' .substr($data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])): 'ー', 0, 9).'</h3>';
                                        echo '<li class="list-inline-item">';
                                            echo '<span class="center mt-2" >';
                                                echo $data['date_set'] != 0 ? date('F j, Y',strtotime($data['date_set'])) : 'ー';
                                            echo '</span>';  
