...
<title><?php echo renderLang($roles_add_role); ?></title>
				...
				<form method="post" action="/submit-add-role">
					<div class="card">
							...
							<div class="row">
								...
								<div class="col-lg-3 col-md-4 col-sm-2">
									...
									<div class="form-group">
										...
										<input type="text" minlength="4" class="form-control required<?php if($role_name_err) { echo ' is-invalid'; } ?>" id="role_name" name="role_name" placeholder="<?php echo renderLang($roles_role_name_placeholder); ?>"<?php if(isset($_SESSION['sys_roles_add_role_name_val'])) { echo ' value="'.$_SESSION['sys_roles_add_role_name_val'].'"'; } ?> required>
						...
						<div class="card-footer text-right">
							<a href="/roles" class="btn btn-secondary mr-1"><i class="fa fa-arrow-left mr-2"></i><?php echo renderLang($btn_back); ?></a>
